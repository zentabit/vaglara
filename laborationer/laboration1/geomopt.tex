...
\begin{figure}[h!]
    ...
    \subfloat[Sfärisk aberration, allt ljus fokuseras inte i brännpunkten.]{\includegraphics[width = 3in]{sphabherr.jpg}} &
    \subfloat[Kromatisk aberration, olika väglängder fokuseras på olika brännpunkter.]{\includegraphics[width = 3in]{kromabherr.jpg}} \\
...
Inledningsvis kan det nämnas att totalreflektion, figur \ref{fig:got}k, kunde iakttas och resultatet är rimligt.
\subsection{Linser}
Vi kan etablera att divergensvinkeln som beräknas i sektion \ref{div} är rimlig (jämfört med blotta ögat).
