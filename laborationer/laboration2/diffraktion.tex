...
\begin{table}[h!]
	...
	\label{table:dubbel}
\end{table}
Mönstret kan förklaras genom att de två smala spalterna fungerar som punktkällor för den inkommande plana vågen. Dessa punktkällors vågor adderas i alla punkter efter spalterna, och där
...
(vågorna interfererar ur fas). Att mönstret blir svagare i kanterna beror på att även diffraktion sker i denna situation och fungerar som ett
"envelope" till interferensmönstret. Detta gäller för alla flerspaltsystem.

\subsubsection{Enkelspalt}
Dubbelspalten byttes ut mot en enkelspalt, och nu skulle istället spaltbredden beräknas, med hjälp av ekvationen för diffraktionsminima, ekvation \ref{eq:enkelspalt}, med
beteckningar enligt tabell \ref{table:enkelspalt}. Mätvärden togs, enligt tabell \ref{table:enkelspalt}. 
\begin{equation}
...
uppstår mellan alla punktkällor som skapas i spaltöppningen (som är förhållandevis bred jämfört med ljusets våglängd) 
när de når en skärm. På vissa punkter träffar alla elementarvågor varandra i fas (exempelvis i huvudmaximum), 
och på andra ställen möts de ur fas och släcker ut varandra.
\begin{figure}[h!]
	\centering
